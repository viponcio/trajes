        ...
        <div class="card-body">
            ...
            <c:forEach var="ru" items="${cores}" >
                <tr>
                    ...
                    <td><a class="btn btn-primary ml-5" href="/buscarRoupaUtensilios/?codRoupaUtensilios=${ru.codRoupaUtensilios}" role="button">Editar</a>
                    <a class="btn btn-primary ml-5" href="/excluirRoupaUtensilios/?codRoupaUtensilios=${ru.codRoupaUtensilios}" role="button">Excluir</a></td>
                </tr>
            </c:forEach>
                </tbody>
            </table>
