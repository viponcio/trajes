...
<header class="masthead text-dark text-center">
    ...
    <div class="container box-left" >
        <div class="page-header">
            <h4>Bem vindo(a),${session['username'].username} !</h4>
        </div>
        <div class="row">
    ...
    <div class="text-center"><h3>Gerenciar Cliente</h3></div>
    ...
    <div class="card posicao" style="width: 50%;">
        ...
        <div class="card-body">
            <table class="table">
                ...
                <%-- <c:forEach var="livro" items="${LivroDAO.livros}"> --%>
                -->
...
<%--                    <a href="/getUserDetails?userId=123"> Get user details</a>--%>
                    <td><a class="btn btn-primary btn-sm" href="/buscarCli/?idCli=${cliente.idCli}" role="button">Editar</a>
                        <a class="btn btn-primary btn-sm" href="/excluirCli/?idCli=${cliente.idCli}" role="button">Excluir</a></td>
                </tr>
                </c:forEach>
