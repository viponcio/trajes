...
<header class="masthead text-dark text-center">
    ...
    <div class="text-center"><h3>Gerenciar Roupa ou Utensílio</h3></div>
                ...
                <c:forEach var="roupaUtensilio" items="${roupaUtensilios}">
                    <tr>
                        ...
                        <td><a class="btn btn-primary btn-sm"
                               href="/buscarRoupaUtensilios/?codRoupaUtensilios=${roupaUtensilio.codRoupaUtensilios}"
                               role="button">Editar</a>
                            <a class="btn btn-primary btn-sm"
                               href="/excluirRoupaUtensilios/?codRoupaUtensilios=${roupaUtensilio.codRoupaUtensilios}"
