...
<header class="masthead text-dark text-center">
    ...
    <h3 class="text-center">Cadastro de Roupa ou Utensílio</h3>
    <div class="container box">

        <form method="post" action="/salvarRoupaUtensilios">
            <label>Tipo de Roupa:
            ...
            <br>
            <label for="tamanho">Tamanho:<input type="text" name="tamanho" id="tamanho" class="form-control"
                                                placeholder="digite o tamanho pode ser letra ou número"></label>
<%--            <br>--%>
            <label for="cor">Cor:<input type="text" name="cor" id="cor" class="form-control" placeholder="digite a cor"></label>
            <label for="precoRoupaUtensilio">Preço:<input type="text" name="precoRoupaUtensilio"
                                                          id="precoRoupaUtensilio" class="form-control"
                                                          placeholder="digite o preço"></label>
            <br>
